...
C’est une opération que nous connaissons déjà. Si nous avons un vecteur représentant par exemple une vitesse, nous pouvons **augmenter ou diminuer** cette vitesse — c’est-à-dire sa longueur — en multipliant le vecteur par un **scalaire** (*scalar*).  
...
Nous verrons comment, à partir des définitions trigonométriques de $\cos$ et $\sin$, on peut dériver ces équations.  
