...
En simulation, nous utilisons donc des **outils mathématiques continus** (calcul différentiel et intégral) pour prédire l’évolution du système, tout en l’approximant à l’aide de **discrétisation numérique**.
